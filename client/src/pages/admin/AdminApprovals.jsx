      ...
      {isLoading ? (
        ...
        <div className="space-y-4">
          {employees.map((emp) => (
            <div
              key={emp.employee_id}
              className="enterprise-card p-5 bg-white border-slate-200 hover:border-slate-300 transition-all shadow-xs space-y-4"
            >
              <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                ...
                <div className="flex flex-wrap items-center gap-2 self-end lg:self-center">
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-slate-100 hover:bg-slate-200 text-slate-700 font-semibold rounded-lg text-xs border border-slate-200 transition-colors"
                  >
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-1 px-3 py-1.5 bg-amber-50 hover:bg-amber-100 text-amber-800 font-semibold rounded-lg text-xs border border-amber-200 transition-colors"
                  >
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-1 px-3 py-1.5 bg-rose-50 hover:bg-rose-100 text-rose-800 font-semibold rounded-lg text-xs border border-rose-200 transition-colors"
                  >
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-1 px-4 py-1.5 bg-emerald-600 hover:bg-emerald-700 text-white font-bold rounded-lg text-xs shadow-xs transition-colors"
                  >
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-1 px-2.5 py-1.5 bg-[#0f2b48] hover:bg-[#1a416b] text-white font-semibold rounded-lg text-xs shadow-xs transition-colors"
              ...
              <div className="flex items-center justify-between pt-2 border-t border-slate-100 text-[11px] text-slate-400">
                <span>Submitted: {new Date(emp.submitted_at || emp.created_at).toLocaleString()}</span>
                <span>
                  Documents: <strong className="text-slate-700">{emp.total_docs || 0} uploaded</strong> ({emp.approved_docs || 0} approved)
                </span>
              </div>
            </div>
          ))}
